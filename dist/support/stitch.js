...
(function() {
  ...
  exports.Package = Package = (function() {
    ...
    function Package(config) {
      ...
      this.compileDependency = function(path, callback) {
        return Package.prototype.compileDependency.apply(_this, arguments);
      };
      ...
      this.mtimeCache = {};
      this.compileCache = {};
      this.name = (_ref5 = config.name) != null ? _ref5 : 'stitch';
    }
    ...
    Package.prototype.compileDependency = function(path, callback) {
    ...
    Package.prototype.compileDependencies = function(callback) {
      var _this = this;
      return async.map(this.dependencies, this.compileDependency, function(err, dependencySources) {
        if (err) {
          return callback(err);
        } else {
    ...
    Package.prototype.getRelativePath = function(path, callback) {
      var base, expandedPath, sourcePath, _i, _len, _ref1;
      sourcePath = path;
      _ref1 = this.paths;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        expandedPath = _ref1[_i];
        base = expandedPath + "/";
