...
(function() {
  var Fs, Logger, PackageJson, Path, Program, Runner, Str, Utils, findProjfile, loadProjfile, log, taskDescriptions, version;
  ...
  Program.version(version).option("-e, --environment [env]", "Set build environment", "development").option("-f, --projfile [file]", "Set project file", "").option("-w, --watch", "Watch and rerun tasks as needed").option("-s, --serve [dir]", "Runs HTTP/HTTPS server").parse(process.argv);
