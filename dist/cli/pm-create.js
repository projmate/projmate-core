...
(function() {
  ...
  program.version(pkg.version).description("Create a project from git repo skeleton").usage("url [dirname]").option("-s, --sub-project", "Select sub project").option("-g, --git-init", "Initialize as git repo").parse(process.argv);
