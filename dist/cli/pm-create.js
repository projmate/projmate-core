...
(function() {
  var Path, create, main, pkg, program;
  ...
  program.version(pkg.version).description("Create a project from git repo skeleton").usage("url [dirname]").option("-g, --git-init", "Initialize as git repo").parse(process.argv);
