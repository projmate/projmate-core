...
(function() {
  var $, Async, Fs, Path, S, Sandbox, Temp, Utils, clone, fetchProject, getMeta, log, read, readSandboxedInputs, realUri, sandbox, template, templayed, updateMeta, walkdir;
  ...
  fetchProject = function(url, dirname) {
  ...
  clone = function(url, dirname, options, cb) {
    ...
    fetchIt = function() {
      ...
      if (Fs.existsSync(dirname)) {
        ...
        return read(opts, function(err, result) {
          if (result === "yes") {
            $.rm_rf(dirname);
            return fetchProject(url, dirname);
          } else {
    ...
    if (options.subProject) {
      return temp.mkdir('pm-create', function(err, tempDir) {
        ...
        return clone("file://" + Path.join(tempDir, options.subProject), dirname, cb);
      });
    } else {
      return fetchIt();
    }
  ...
  exports.run = function(options) {
    var dirname, inputs, readUserInput, updateFileAndContentTemplates, url;
    if (options == null) {
      options = {};
    }
    if (!options.url) {
