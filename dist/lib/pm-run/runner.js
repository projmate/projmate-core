...
(function() {
  var Async, FilterCollection, Logger, Path, Runner, Server, Sex, Task, Util, log, _,
    _this = this,
    __slice = [].slice;
  ...
  Runner = (function() {
    ...
    function Runner(options) {
      ...
      this.executeTasks = function(taskNames, cb) {
        return Runner.prototype.executeTasks.apply(_this, arguments);
      };
      global.PROJMATE = {};
