...
#     options: {}
#   # 'hogan.js':
#   #   extensions: ['hogan', 'mustache']
#   #   module: 'hogan.js'
#   #   options:
#   #     asString: true

# # Compilers are loaded only if the module has been installed.
# for mod, v of extensionMap
#   do (mod, v) ->
#     try
#       Compiler = require(mod)
#       for ext in v.extensions
#         compilers[ext] = (module, filename) ->
#           content = fs.readFileSync(filename, 'utf8')
#           output = Compiler.compile(content, v.options)
  ...
  compileSources: (callback) =>
    async.reduce @paths, {}, _.bind(@gatherSourcesFromPath, @), (err, sources) =>
      ...
      for name, {filename, source} of sources
        ...
        result += ": function(exports, require, module, __filename, __dirname) {#{source}}"
